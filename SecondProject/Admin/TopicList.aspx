<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Admin.Master" AutoEventWireup="true" CodeBehind="TopicList.aspx.cs" Inherits="SecondProject.Admin.TopicList" ValidateRequest="false"%>
                ...
                <div class="card-body">
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered mt-4" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Video Embed Code">
                                <ItemTemplate>
                                    <asp:Label ID="Label3" runat="server" Text='<%# Eval("VideoEmbedCode") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Action">
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnEdit" runat="server" CommandName="EditTp" CommandArgument='<%# Eval("TopicId") %>' CssClass="me-2" ToolTip="Edit">
                                        <i class="bi bi-pencil-square"></i>
                                    </asp:LinkButton>
                                    <asp:LinkButton ID="btnDelete" runat="server" CommandName="DeleteTp" CommandArgument='<%# Eval("TopicId") %>' ToolTip="Delete">
      ...
      <div class="modal-body">
          ...
          <asp:UpdatePanel ID="UpdatePanel1" runat="server">
              <ContentTemplate>
                  ...
                  <div class="mb-3">
                  <label for="txtEmbedCode" class="form-label">Video Embed Code</label>
                  <asp:TextBox ID="txtEmbedCode" runat="server" CssClass="form-control" placeholder="Enter Video Embed Code"></asp:TextBox>
                </div>
                <div class="mb-3">
                  <label for="txtDuration" class="form-label">Duration</label>
                  <asp:TextBox ID="txtDuration" runat="server" CssClass="form-control" placeholder="e.g. 00:05:30"></asp:TextBox>
                </div>
